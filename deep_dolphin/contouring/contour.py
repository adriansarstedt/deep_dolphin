...
class Contour(object):
    ...
    def is_simple(self):
        return self.is_small() or LineString(self.vertices).is_simple
    ...
    def doesnt_intersect(self, line_strings):
        return not self.intersects(line_strings)
    ...
    def angle_to_point(self, p):
        return -1 * angle_between_points(
            self.previous_vertice(), self.last_vertice(), p
        )

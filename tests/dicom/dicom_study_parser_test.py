...
class DicomStudyParserTest(unittest.TestCase):
    ...
    def test_get(self):
        self.assertEqual(
            self.study_parser.get("StudyInstanceUID"),
            "1.3.6.1.4.1.19291.2.1.1.116221177219232116612168727612",
        )
        ...
        self.assertEqual(
            self.study_parser.get("ReferringPhysicianName"), "WADA^MORIKATSU"
        )
